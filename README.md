...
|-------------|-----------|----------------|
| *[Add screenshot1.png]* | *[Add screenshot2.png]* | *[Add screenshot3.png]* |
...
1. Download `pocket-money-saver.html`
...
```bash
git clone https://github.com/yourusername/pocket-money-saver.git
cd pocket-money-saver
...
4. Your app will be live at `https://yourusername.github.io/pocket-money-saver`
...
### 1. Add Money
- Click **"+ Add Money"**
- Enter amount and source (Allowance, Chores, Gift, etc.)
...
- Click **"+ New Goal"**
- Enter goal name (e.g., "New Bicycle") and target amount
...
- **JavaScript (Vanilla)** - Logic, DOM manipulation, local storage
